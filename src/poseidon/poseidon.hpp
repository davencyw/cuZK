...
public:
  ...
  static FieldElement hash_pair(const FieldElement &left,
...
private:
  ...
  static void
  add_round_constants(FieldElement state[PoseidonParams::STATE_SIZE],
                      size_t round);
  static void apply_sbox(FieldElement state[PoseidonParams::STATE_SIZE]);
  static void
  apply_partial_sbox(FieldElement state[PoseidonParams::STATE_SIZE]);
